...
def build_parser() -> argparse.ArgumentParser:
    ...
    run.add_argument("question", help="Research question to investigate.")
    ...
    goal.add_argument("question", help="Research question or project goal.")
    ...
    discover.add_argument("--db", default=".mechferret/memory.sqlite", help="SQLite memory path.")
    ...
    discover.add_argument("--provider", choices=["auto", "local", "openai", "anthropic"], default="auto", help="Provider for prior-art search and critique.")
    discover.add_argument("--llm-model", help="Override the configured provider model for prior-art search.")
    discover.add_argument("--no-memory", action="store_true", help="Do not recall prior-run memory.")
    ...
    quick.add_argument("--mode", choices=["all", "demo", "openvla", "ci"], default="all", help="Quickstart path to print or run.")
    ...
    registry.add_argument("--kind", choices=["tool", "task", "playbook", "evaluator"], help="Limit registry output to one item kind.")
    ...
    memory.add_argument("--db", default=".mechferret/memory.sqlite", help="SQLite memory path.")
    ...
    paper.add_argument("--provider", choices=["auto", "local", "openai", "anthropic"], default="auto", help="Provider for paper drafting.")
    ...
    review.add_argument("--provider", choices=["auto", "openai", "anthropic"], default="auto", help="Provider for paper review.")
    ...
    sae.add_argument("project", choices=["openvla"], help="SAE project to operate on.")
    sae.add_argument("action", nargs="?", default="status", choices=["status", "init", "plan", "commands", "validate-manifest", "create-manifest", "smoke", "eval", "features", "dossier"], help="Project workflow action.")
